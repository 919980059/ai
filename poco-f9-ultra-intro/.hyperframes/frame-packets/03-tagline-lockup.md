# Frame packet: 03-tagline-lockup
...
Scene 1 (0.0–0.40s): the cut settles — the footage continues, the scrim deepens from ~35% toward ~50%; text-free stage.
Scene 2 (0.40–1.54s): the ONE move, one continuous assembly gesture — the tracked "POCO" label ramps in above (0.40–1.10s), the single 1px POCO-yellow hairline draws beneath it (0.55–1.25s), and "Ultrapower Unbound" rises (0.70–1.54s, fade + slight rise, power3.out), completing at 1.54s — cut-time 9.15s, the deepest breathing point on the grid.
