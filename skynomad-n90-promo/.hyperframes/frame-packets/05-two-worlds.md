...
- scene: 纸白版面左右对开：陆地公务舱（商务）与全家舒适（家庭）两张等重摄影面板镜像入场；中缝酒红发丝线
- voiceover: "商务，是陆地公务舱；家庭，是移动的生活空间。"
- duration: 5.6s
- vo_cues: 05.wav @0.20 (5.12s) — 实测：「商务」0.20–0.80 ·「是陆地公务舱」0.80–2.90 · 分号 2.90–3.19 ·「家庭」3.19–3.49 ·「是移动的生活空间」3.49–5.21 · VO 尾 5.21
...
- **Scene 2 (0.20–1.0s) 左界开** — VO「商务」→ 左面板（New_2.jpg）自中缝 book-open：镜像 rotateY 入场（split-tilt-cards 左半，入场 x/scale 与 idle 分层，永不互撞），0.85→1 落定；「商务」标签 0.20 落于面板外缘。
- **Scene 3 (1.0–2.90s) 左界徽标** — VO「是陆地公务舱」→ pill 徽标「陆地公务舱」~1.4 落于面板内缘（克制落定 — 全帧唯一 spring 强调，无 overshoot）。
- **Scene 4 (3.19–4.0s) 右界开** — VO「家庭」→ 右面板（New_4.jpg）以同形 book-open 自中缝镜像入场（同一入场形、同一落法定成镜像）；「家庭」标签 3.19。
- **Scene 5 (4.0–5.6s) 右界徽标 + 静持** — pill「移动的生活空间」~4.3 落于右面板内缘（与左侧 ~0.3s 节奏呼应）；5.21–5.6 held read；**双面板静止不浮**（split-tilt-cards 的 phase-opposed 漂浮明确不用 — 静止胜于坏动）。
